...
const Animation = ({ setAnimation }) => {
  ...
  const canv = () => {
    ...
    // body.fillStyle = "red"; // Set the fill style to red
    ...
    Composite.add(world, [
      // falling blocks
      body,
      Bodies.rectangle(200, 100, 60, 60, { frictionAir: 0.0001 * box1 }),
      Bodies.rectangle(400, 100, 60, 60, { frictionAir: 0.005 * box2 }),
      Bodies.rectangle(600, 100, 60, 60, { frictionAir: 0.01 * box3 }),
  ...
  return (
    <div className="animation-btn fade-in">
      <h3 className="pad">air friction</h3>
